...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        ...
        # we want to return False from <future_question.was_published_recently()>
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        """
        create_question(question_text="Future test question.", days=30)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, 'No polls are available.')
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = create_question(question_text='Past multi-question 1', days=-30)
        question2 = create_question(question_text='Past multi-question 2', days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question1, question2],
